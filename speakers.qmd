...
<div class="speaker-grid">
  ...
  <div class="speaker-card" id="reinhard-pekrun">
    <div class="speaker-photo-wrap">
      <img class="speaker-photo" src="images/speakers/pekrun-rinehard.jpg" alt="Reinhard Pekrun">
    </div>
    <div class="speaker-body">
      <div class="speaker-name">Reinhard Pekrun</div>
      <div class="speaker-role">Professor of Psychology, University of Essex; Professorial Fellow, Institute for Positive Psychology and Education, Australian Catholic University</div>
      <p class="speaker-bio">Reinhard Pekrun is a professor of psychology at the University of Essex, United Kingdom, and a professorial fellow at the Institute for Positive Psychology and Education, Australian Catholic University, Sydney, Australia. His research areas include achievement motivation and emotion, personality development, and educational assessment and evaluation. Pekrun pioneered research on emotions in education and originated the Control-Value Theory of Achievement Emotions. He is a Web of Science Highly Cited Researcher and has authored more than 400 publications. Pekrun received the Diefenbaker Award 2015, the AERA Sylvia Scribner Award 2017, the EARLI Oeuvre Award 2017, the Lifetime Achievement Award 2018 from the German Psychological Society, and the Shavelson Distinguished Researcher and Lifetime Achievement Award 2025.</p>
      <button class="speaker-more" type="button">Read more +</button>
      <a class="speaker-link" href="program.html">Plenary: Control, Value, and Emotion →</a>
    </div>
  </div>

  <div class="speaker-card" id="mutlu-cukurova">
    <div class="speaker-photo-wrap">
      <img class="speaker-photo" src="images/speakers/mutlu-cukurova.jpg" alt="Mutlu Cukurova">
    </div>
    <div class="speaker-body">
      <div class="speaker-name">Mutlu Cukurova</div>
      <div class="speaker-role">Professor of Learning and Artificial Intelligence, UCL Knowledge Lab, University College London</div>
      <p class="speaker-bio">Mutlu Cukurova is Professor of Learning and Artificial Intelligence at the UCL Knowledge Lab, University College London, where he directs the UCLAIT research group and is affiliated with the UCL Centre for Artificial Intelligence. His work spans human–AI complementarity, multimodal learning analytics, and AI in education, comprising some 220 publications and over 17K citations. Editor-in-Chief of the British Journal of Educational Technology, he advises UNESCO, the OECD, the World Bank, and the European Commission, and co-authored the UNESCO AI Competency Framework for Teachers.</p>
      <button class="speaker-more" type="button">Read more +</button>
      <a class="speaker-link" href="program.html#three-speeds-of-ai-literacy">Panel: Three Speeds of AI Literacy →</a>
    </div>
  </div>

  <div class="speaker-card" id="melanie-hughes">
    <div class="speaker-photo-wrap">
      <img class="speaker-photo" src="images/speakers/melanie-hughes.png" alt="Melanie Hughes">
    </div>
    <div class="speaker-body">
      <div class="speaker-name">Melanie Hughes</div>
      <div class="speaker-role">Curriculum Specialist, Technologies, Australian Curriculum, Assessment and Reporting Authority (ACARA)</div>
      <p class="speaker-bio">Melanie Hughes is Curriculum Specialist, Technologies at the Australian Curriculum, Assessment and Reporting Authority (ACARA), where she leads the Australian Curriculum: Technologies — spanning Design and Technologies, Digital Technologies, and the Digital Literacy capability. An experienced Primary and Secondary teacher, she has worked across cross-sectoral technologies projects, served as a board member of ICTENSW, and was Senior Project Officer for ACARA's Digital Technologies in Focus project. Her career spans classroom teaching, curriculum leadership, and technologies integration, including roles as Education Consultant: Technologies and STEM with AISNSW and Senior Education Specialist: Technologies and STEM at the Australian Academy of Science.</p>
      <button class="speaker-more" type="button">Read more +</button>
      <a class="speaker-link" href="program.html#three-speeds-of-ai-literacy">Panel: Three Speeds of AI Literacy →</a>
    </div>
  </div>

  <div class="speaker-card" id="lisa-lim">
    <div class="speaker-photo-wrap">
      <img class="speaker-photo" src="images/speakers/lisa-lim.jpg" alt="Lisa-Angelique Lim">
    </div>
    <div class="speaker-body">
      <div class="speaker-name">Lisa-Angelique Lim</div>
      <div class="speaker-role">Lecturer, Connected Intelligence Centre, University of Technology Sydney; ASCILITE</div>
      <p class="speaker-bio">Lisa-Angelique Lim is a Lecturer with the Connected Intelligence Centre at the University of Technology Sydney. Lisa holds a PhD in Education specialising in learning analytics. Her research focuses on the human-centred co-design and implementation of learning analytics and AI tools that foster meaningful student experiences. Lisa works closely with educators in higher education with a mission to co-design learning analytics and AI interventions, recognising that learning analytics and AI are inherently socio-technical and must be embedded intentionally within institutional practice. Lisa has published her work in leading educational technology journals and the International Learning Analytics and Knowledge (LAK) conference.</p>
      <button class="speaker-more" type="button">Read more +</button>
      <a class="speaker-link" href="program.html#three-speeds-of-ai-literacy">Panel: Three Speeds of AI Literacy →</a>
    </div>
  </div>

  <div class="speaker-card" id="sam-sellar">
    <div class="speaker-photo-wrap">
      <img class="speaker-photo" src="images/speakers/sam-sellar.jpeg" alt="Sam Sellar">
    </div>
    <div class="speaker-body">
      <div class="speaker-name">Sam Sellar</div>
      <div class="speaker-role">Dean of Research, College of Education, Behavioural and Social Sciences (EBSS); Professor of Education Policy, Adelaide University</div>
      <p class="speaker-bio">Sam Sellar is Dean of Research in the College of Education, Behavioural and Social Sciences (EBSS) and Professor of Education Policy at Adelaide University. Sam's research focuses on education policy, large-scale assessments and the datafication of education. He is currently co-investigator for an ESRC project investigating digital platforms in higher education (led by Janja Komljenovic, Lancaster University). Sam has published more than 70 books, book chapters and journal articles, and he is Lead Editor of Discourse: Studies in the Cultural Politics of Education. His forthcoming book is Algorithms of Education: How datafication and artificial intelligence shape policy, co-authored with Kalervo N. Gulson and P. Taylor Webb.</p>
      <button class="speaker-more" type="button">Read more +</button>
      <a class="speaker-link" href="program.html">Plenary: Making Sense of Day One — and Navigating the Funding Landscape →</a>
    </div>
  </div>
  ...
  <div class="speaker-card" id="oscar-deho">
    ...
    <div class="speaker-body">
      ...
      <button class="speaker-more" type="button">Read more +</button>
      <a class="speaker-link" href="sessions.html#data-ethics-in-education-consent-privacy-and-the-datafication-of-learning">Data Ethics in Education →</a>
    </div>
  </div>
  ...
  <div class="speaker-card" id="florence-gabriel">
    <div class="speaker-photo-wrap">
      <img class="speaker-photo" src="images/speakers/florence-gabriele.jpg" alt="Florence Gabriel">
    </div>
    <div class="speaker-body">
      <div class="speaker-name">Florence Gabriel</div>
      <div class="speaker-role">Enterprise Fellow in Education &amp; Senior Research Fellow, C3L, Adelaide University</div>
      <p class="speaker-bio">Dr Florence Gabriel is an Enterprise Fellow in education and a Senior Research Fellow at the Centre for Change and Complexity in Learning (C3L). She specialises in cognitive and socio-emotional aspects of learning and student well-being. Her research focuses on self-regulated learning, mathematics anxiety, and the use of technology to support learning. She has contributed to global education policy through her work with UNESCO and the OECD. She is also the co-Editor-in-Chief of Learning Letters.</p>
      <button class="speaker-more" type="button">Read more +</button>
    </div>
  </div>
  ...
  <div class="speaker-card" id="jarrod-johnson">
    <div class="speaker-photo-wrap">
      <img class="speaker-photo" src="images/speakers/jarrod-johnson.jpeg" alt="Jarrod Johnson">
    </div>
    <div class="speaker-body">
      <div class="speaker-name">Jarrod Johnson</div>
      <div class="speaker-role">Science and Technologies Educator, Pulteney Grammar School; Adjunct Research Fellow, C3L, Adelaide University</div>
      <p class="speaker-bio">Jarrod Johnson is a Science and Technologies educator at Pulteney Grammar School and an Adjunct Research Fellow with the Centre for Change and Complexity in Learning (C3L) at Adelaide University. His work focuses on developing practical AI tools and pedagogical approaches that support teaching, learning, and academic integrity in the classroom. Through his collaboration with C3L, Jarrod helps bridge educational research and classroom practice by trialling innovative AI applications, collecting real-time classroom data, and evaluating their impact on student learning. He is passionate about helping educators adopt AI in ways that are ethical, practical, and evidence-informed.</p>
      <button class="speaker-more" type="button">Read more +</button>
      <a class="speaker-link" href="sessions.html#a-working-prototype-for-real-time-surfacing-of-learning-dispositions-in-k-12-collaborative-learning">Real-Time Learning Dispositions in K-12 →</a>
    </div>
  </div>
