...
<div class="who-section">
  <div class="who-inner">
    <h2>Who is it for?</h2>
    <ul class="who-list">
      <li>Higher Degree by Research (HDR) students looking to build skills in methods, AI tools, and grant strategy</li>
...
<div class="info-strip">
  ...
  <div class="info-item">
    ...
    <span class="info-val">City East</span>
  </div>
  <a class="register-btn" href="https://events.humanitix.com/YOUR-EVENT-LINK" target="_blank" rel="noopener">Register interest</a>
</div>
```
