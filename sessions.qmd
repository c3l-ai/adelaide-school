...
<div class="glance-grid">
  ...
  <div class="glance-track-col">
    ...
    <a class="glance-card ls" href="#classroom-dialogue-as-data-a-working-prototype-for-surfacing-learning-dispositions-in-real-time">
      <div class="glance-card-title">Classroom Dialogue as Data: A Working Prototype for Real-Time Surfacing Learning Dispositions</div>
    ...
    <a class="glance-card ls" href="#tracing-self-regulation-analysing-process-data-in-learning-research">
      ...
      <div class="glance-card-presenter">Florence Gabriel</div>
    </a>
    ...
    <a class="glance-card ls" href="#what-are-we-actually-measuring-validity-constructs-and-the-hard-problem-of-learning-data">
      ...
      <div class="glance-card-presenter">Flora Jin &amp; Abhinava Barthakur</div>
    </a>
...
::: {.card-session .track-ls}
### Classroom Dialogue as Data: A Working Prototype for Real-Time Surfacing Learning Dispositions
*Andrew Zamecnik*

This session walks through a working prototype that puts AI agents into a K-12 classroom in real time — aligned to curriculum frameworks, assessing learning dispositions as they emerge in discourse. Andrew Zamecnik covers what it takes to make this work: the audio and video infrastructure, the tradeoffs of capturing classroom speech at scale, and what the system can and can't yet reliably detect.
:::
