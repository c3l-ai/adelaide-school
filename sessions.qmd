---
title: "Sessions"
subtitle: "Twelve parallel sessions across two tracks."
---

Parallel sessions run across two blocks on Day One. Each session runs for 90 minutes and is designed to be hands-on and participatory — not a lecture. Choose based on where you want to go deeper.

Sessions are grouped into two tracks, though the boundaries are deliberately porous. Many of the best conversations happen when someone from the learning sciences track wanders into an AI tools session, and vice versa.
